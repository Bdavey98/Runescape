...
// Start of minigame objects
		// Portals
		
		c.getPA().checkObjectSpawn(13623, 2746, 9643, 2, 10); // easy portal
		c.getPA().checkObjectSpawn(13624, 2749, 9643, 2, 10); // medium portal
		c.getPA().checkObjectSpawn(13626, 2752, 9643, 2, 10); // hard portal
		c.getPA().checkObjectSpawn(13618, 2755, 9632, 1, 10); // exit portal
		
		// west wall of waiting room
		c.getPA().checkObjectSpawn(849, 2745, 9643, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9642, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9641, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9640, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9639, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9638, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9637, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9636, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9635, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9634, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9633, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9632, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9631, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9630, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9629, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9628, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9627, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9626, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9625, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9624, 2, 10);
		c.getPA().checkObjectSpawn(849, 2745, 9623, 2, 10);

		
		// south wall of waiting room 
		c.getPA().checkObjectSpawn(849, 2746, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2747, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2748, 9622, 1, 10);
		//c.getPA().checkObjectSpawn(849, 2749, 9633, 1, 10);
		//c.getPA().checkObjectSpawn(849, 2750, 9633, 1, 10);
		c.getPA().checkObjectSpawn(849, 2751, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2752, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2753, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2755, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2756, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2757, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2758, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2759, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2760, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2761, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2762, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2763, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2764, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2765, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2766, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2767, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2768, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2769, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2770, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2771, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2772, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2773, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2774, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2775, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2776, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2777, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2778, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2779, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2780, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2781, 9622, 1, 10);
		c.getPA().checkObjectSpawn(849, 2782, 9622, 1, 10);


		
		// east wall of waiting room
		c.getPA().checkObjectSpawn(849, 2754, 9643, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9642, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9641, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9640, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9639, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9638, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9637, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9636, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9635, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9634, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9633, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9632, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9631, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9630, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9629, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9628, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9627, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9626, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9625, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9624, 4, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9623, 4, 10);

		//east wall of combat area
		c.getPA().checkObjectSpawn(849, 2783, 9643, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9642, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9641, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9640, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9639, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9638, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9637, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9636, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9635, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9634, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9633, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9632, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9631, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9630, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9629, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9628, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9627, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9626, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9625, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9624, 4,10);
		c.getPA().checkObjectSpawn(849, 2783, 9623, 4,10);

		
		// north wall of waiting room
		c.getPA().checkObjectSpawn(849, 2746, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2747, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2748, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2749, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2750, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2751, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2752, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2753, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2754, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2755, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2756, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2757, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2758, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2759, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2760, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2761, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2762, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2763, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2764, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2765, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2766, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2767, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2768, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2769, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2770, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2771, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2772, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2773, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2774, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2775, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2776, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2777, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2778, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2779, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2780, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2781, 9644, 3, 10);
		c.getPA().checkObjectSpawn(849, 2782, 9644, 3, 10);

		// scenery stuff
		c.getPA().checkObjectSpawn(4288, 2746, 9633, 3, 10); // bed 1
		c.getPA().checkObjectSpawn(4288, 2746, 9628, 3, 10); // bed 2
		c.getPA().checkObjectSpawn(714, 2746, 9631, 4, 10); // fire
		c.getPA().checkObjectSpawn(11695, 2748, 9623, 3, 10); // statues
		c.getPA().checkObjectSpawn(11695, 2751, 9623, 1, 10); // statues
	
		c.getPA().checkObjectSpawn(4520, 2760, 9638, 2, 10); // skeleton
		c.getPA().checkObjectSpawn(4520, 2771, 9639, 2, 10); // skeleton
		c.getPA().checkObjectSpawn(4520, 2777, 9638, 1, 10); // skeleton
		c.getPA().checkObjectSpawn(11911, 2768, 9629, 2, 10); // dead bush
		c.getPA().checkObjectSpawn(444, 2760, 9627, 2, 10); // boulder
		c.getPA().checkObjectSpawn(660, 2782, 9623, 2, 10); // skele
		c.getPA().checkObjectSpawn(672, 2782, 9624, 2, 10); // barrel
...
c.getPA().checkObjectSpawn(4874, 3084, 3488, 1, 10);//Stall level 1
c.getPA().checkObjectSpawn(4875, 3084, 3490, 1, 10);//Stall level 25
c.getPA().checkObjectSpawn(4876, 3084, 3492, 0, 10);//Stall level 50
c.getPA().checkObjectSpawn(4877, 3084, 3494, 0, 10);//Stall level 75
c.getPA().checkObjectSpawn(4878, 3084, 3496, 0, 10);//Stall level 90
...
c.getPA().checkObjectSpawn(410, 3098, 3501, 1, 10);//Lunar Magic
c.getPA().checkObjectSpawn(411, 3098, 3506, 2, 10);//Curse Prayers
c.getPA().checkObjectSpawn(172, 3097, 3498, 2, 10);//CkeyChest
