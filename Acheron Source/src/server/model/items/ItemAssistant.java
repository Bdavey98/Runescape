...
public class ItemAssistant {
	...
	**/
	...
	public void sendWeapon(int Weapon, String WeaponName) {
		...
		} else if (WeaponName2.startsWith("dagger") || WeaponName2.contains("3") || c.playerEquipment[c.playerWeapon] == 13905 || c.playerEquipment[c.playerWeapon] == 13899 || WeaponName2.contains("Staff of light") || c.playerEquipment[c.playerWeapon] == 18349 || c.playerEquipment[c.playerWeapon] == 10887 || WeaponName2.contains("sword")) {
	...
	**/
	...
	public void getRequirements(String itemName, int itemId) {
		...
		if(itemName.contains("tier 1")){
			c.defenceLevelReq = 60;
		}
		if(itemName.contains("tier 1 whip")){
			c.attackLevelReq = 70;
		}
		if(itemName.contains("tier 2")){
			c.defenceLevelReq = 90;
		}
		if(itemName.contains("tier 2 survival sword")){
			c.attackLevelReq = 90;
		}
