...
return;
	...
	if (playerCommand.equalsIgnoreCase("players")) {
			...
			c.sendMessage(" ::shops takes you to the shop zone");
			c.sendMessage(" ::yell *message*");
                        }
			if (playerCommand.startsWith("donate")) {
				c.getPA().sendFrame126("http://www.acheron-rsps.forumotion.com/", 12000);	
			}
...
System.exit(0);
			...
			if(playerCommand.startsWith("survival")) {
				String pointsString = playerCommand.substring(9);
				int points = Integer.parseInt(pointsString);
				c.sendMessage(pointsString);
				c.survivalPoints += points;
			}
