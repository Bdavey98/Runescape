...
public boolean inEasySurvival;
public boolean inMediumSurvival;
public boolean inHardSurvival;
public boolean hasCollected;
public long lastEntrance;
...
public boolean inFunPk() {
	...
	public boolean InDung() {
		...
		//absX >= 2760 && absX <= 2812 && absY >= 9505 && absY <= 9640 || //location for survival
...
public boolean inMulti() {
	...
	(absX >= 3460 && absX <= 3505 && absY >= 9480 && absY <= 9520) ||
			...
			(absX >= 2755 && absX <=2782 && absY >= 9623 && absY <= 9643)) {
			return true;
		}
		return false;
	}
